        ...
        <div className="listingExpanded-component">
            ...
            {isExpandedBasicInfo && <div className="listingExpanded-component-basicInfoExpanded">
                <div className="listingExpanded-component-basicInfoExpanded-generalInstructions-div">
                    ...
                    <p className="listingExpanded-generalInstructions-paragraph">
                        ...
                        selected candidates.
                        <br/>
                        - Candidates who have appeared for any test held by Zeus Learning in the past 12 months will not
                ...
                <div className="listingExpanded-component-basicInfoExpanded-generalInstructions-div">
                    <label className="listingExpanded-generalInstructions-label">General Instructions :</label>
                    <p className="listingExpanded-generalInstructions-paragraph">
                        - Candidates are requested to log in half an hour prior to the exam start time as they would
                        need to capture their image using a web camera. By taking this test, you are permitting the
                        examination system to capture your video for invigilation purposes.
                        <br/>
                        - Candidates would not be able to appear for the exam if the web camera attached to their system
                        is not functional.
                        <br/>
                        - The web camera of your system must be enabled and must remain switched on throughout the
                        examination. In the event of non-receipt of a webcam, your examination will be considered null
                        and void.
                        <br/>
                        - Candidate’s audio and video will be recorded during the examination and will also be monitored
                        by a live proctor. The proctor may terminate your exam in case he/she observes any malpractice
                        during the exam.
                        <br/>
                        - Candidates are advised to use their own Laptop/PC with a stable internet connection (min 1
                ...
                <hr className="listingExpanded-separator"/>
                <div className="listingExpanded-component-basicInfoExpanded-generalInstructions-div">
                    <label className="listingExpanded-generalInstructions-label">Minimum System Requirements :</label>
                    <p className="listingExpanded-generalInstructions-paragraph">
            ...
            <div className="listingExpanded-timeslot-preferences">
                <div className="listingExpanded-timeslot-preferences--labelContainer">
                    <label className="listingExpanded-timeslot-preferences-mainLabel">Time Slots & Preferences</label>
                </div>
                <div className="listingExpanded-timeslot-choice-container">
                    <label className="listingExpanded-timeslot-choice-container-label">Select a Time Slot :</label>
                ...
                <div className="listingExpanded-roles-choice-container">
                    <label className="listingExpanded-roles-choice-container-label">Select Your Preference :</label>
                    <div className="listingExpanded-checkboxes">
                        {
                            textDataFull[id - 1].rolesData.map((roleData) => {
                                return (
                                    <div key={roleData.name}>
                                        <input type="checkbox" id={roleData.name}
                                               name={roleData.name}/>
